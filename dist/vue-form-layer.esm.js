...
__vue_render__$2._withStripped = true;
  ...
  const __vue_inject_styles__$3 = function (inject) {
    if (!inject) return
    inject("data-v-2c71812e_0", { source: "\n.vue-col{\r\n  color: red;\n}\r\n", map: {"version":3,"sources":["F:\\blryli\\组件\\vue-rollup-template\\src\\components\\col\\col.vue"],"names":[],"mappings":";AA6CA;EACA,UAAA;AACA","file":"col.vue","sourcesContent":["<template>\r\n  <div class=\"vue-col\" :style=\"style\">\r\n    <slot></slot>\r\n  </div>\r\n</template>\r\n\r\n<script>\r\nexport default {\r\n  name: \"VueCol\",\r\n  props: {\r\n    span: Number\r\n  },\r\n  data() {\r\n    return {};\r\n  },\r\n  computed: {\r\n    style() {\r\n      let style = {};\r\n\r\n      if (this.gutter) {\r\n        style.paddingLeft = this.gutter / 2 + \"px\";\r\n        style.paddingRight = style.paddingLeft;\r\n      }\r\n\r\n      if(this.span) {\r\n        style.width =  Math.floor((this.span / 24 * 100) * 10000) / 10000 + \"%\";\r\n      } else {\r\n        style.width = '100%';\r\n      }\r\n\r\n      return style;\r\n    },\r\n    gutter() {\r\n      let parent = this.$parent;\r\n      while (parent && parent.$options.name !== \"VueRow\") {\r\n        parent = parent.$parent;\r\n      }\r\n      return parent ? parent.gutter : 0;\r\n    }\r\n  },\r\n  methods: {}\r\n};\r\n</script>\r\n\r\n<style>\r\n.vue-col{\r\n  color: red;\r\n}\r\n</style>\r\n\r\n"]}, media: undefined });
...
export { vueCol as Col, Content, vueForm as Form, vueFormItem as FormItem, VueFormLine as FormLine, Layer, VuePopover as Popover, RenderSlot, VueText };
